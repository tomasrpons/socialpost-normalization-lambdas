...
class TwitterStrategy(Strategy):
    """
    Implementation to normalize RAW Twitter raw profile.
    """
    ...
    def process_common_profile(self) -> Dict:
        """
        This method will recieve a RAW Twitter raw profile, normalize it and return it.
        """
        try:
            ...
            profile_url = "https://www.twitter.com/{}".format(profile_username)
            profile_image_url = (
                self.profile.raw_profile.get("data")
                .get("M")
                .get("data")
